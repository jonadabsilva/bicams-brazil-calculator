...
conversion_table <- list(
  ...
  BVMT_Total = list(
    "3"  = c(-Inf,  2),  "4"  = c(3,   5),  "5"  = c(6,   8),
    "6"  = c(9,  12),  "7"  = c(13, 17), "8"  = c(18, 20),
    "9"  = c(21, 23),  "10" = c(24, 26), "11" = c(27, 28),
    "12" = c(29, 30), "13" = c(31, 32), "14" = c(33, 34),
    "15" = c(35, 35), "16" = c(36, Inf)
  ),
  SDMT = list(
    "3"  = c(-Inf,  9),  "4"  = c(10, 17), "5"  = c(18, 23),
    "6"  = c(24, 29), "7"  = c(30, 36), "8"  = c(37, 43),
    "9"  = c(44, 49), "10" = c(50, 53), "11" = c(54, 58),
    "12" = c(59, 62), "13" = c(63, 68), "14" = c(69, 74),
    "15" = c(75, 79), "16" = c(80, 93), "17" = c(94,107),
    "18" = c(108, Inf)
  )
)
